...
const formId = document.getElementById("hidden_form_id").value  
const waitForElement = (selector) => {
  return new Promise((resolve) => {
    ...
    observer.observe(document.querySelector("div.entitylist.entity-grid"), {
      childList: true,
      subtree: true
    })
  })
...
waitForElement("a.edit-link.launch-modal").then((links) => {
  links.forEach(link => {
    link.setAttribute("data-entityformid",formId)
  });
})