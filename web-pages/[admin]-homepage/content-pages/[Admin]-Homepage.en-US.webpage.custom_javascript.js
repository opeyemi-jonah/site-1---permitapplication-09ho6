$(document).ready(function (){
    ...
    $('#entitylist-filters').attr('role', 'none');
    $('.entitylist-filter-option-group').appendTo($('.filter-group'));
    $('.filter-group').wrapInner('<ul>');
    $('.float-end > .btn-entitylist-filter-submit').appendTo($('.filter-group'));
    ...
    $('#entitylist-filters > div.filter-group > ul > li > ul > li > div > span').css({
        "display": "none"
    });
